...
dirtTest = tile0:getCanvasFromBlockMap(dirtmap, 10, 10)
topDirtTest = tile0:getCanvasFromBlockMap(topdirtmap, 10, 10)
tile1 = tiler.create(assets.terrainTextures.grass, 32, 32)
terrainTest = tile1:getCanvasFromBlockMap(grassmap, 10, 10)
topGrassTest = tile1:getCanvasFromBlockMap(topgrassmap, 10, 10)
